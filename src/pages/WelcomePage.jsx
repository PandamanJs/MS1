...
function WelcomePage() {
  ...
  const handleProceed = async () => {
    ...
    try {
      ...
      const res = await fetch(`${apiUrl}/students/students/student-lookup`, {
        method: "POST",
      ...
      if (data.data[0]) {
        ...
        parentName = data.data[0].parent_name || `${data.data[0].first_name} ${data.data[0].last_name}`;
      }
    ...
    <main className={styles.main}>
      ...
      <section className={styles.schoolSection}>
        ...
        <div className={styles.inputs}>
          ...
          <Button message={"Proceed"} givenClassName="active" onClick={handleProceed}></Button>
        </div>
